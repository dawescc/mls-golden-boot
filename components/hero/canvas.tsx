...
import { liquidFragSource } from "@/components/hero/liquid-frag";
...
export function Canvas({ imageData, params, processing }: { imageData: ImageData; params: ShaderParams; processing: boolean }) {
